...
class ConeMatchingInput:
    ...
    def __init__(self, sorted_cones=[np.zeros((0, 2)) for _ in ConeTypes], vehicle_pos: FloatArray = np.zeros(2), vehicle_dir: FloatArray = np.zeros(2)):
        self.sorted_cones = sorted_cones
        self.slam_position = vehicle_pos
        self.slam_direction = vehicle_dir
